...
function DeleteSub({ sub , onDeleteSub }) {
  ...
  const handleSubmit = () => {
    onDeleteSub({ ...deleteSub, id: sub.id });
    closeModal();
          ...
          >
            <div className="flex justify-between">
              <h2 className="text-lg font-semibold mb-4 drop-shadow-md mr-8">
                Are you sure you want to delete this Sub Cargo?
              </h2>
